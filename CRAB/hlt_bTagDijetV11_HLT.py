...
# load the ED analyzer for making ntuples (Ntuplizer) -- see
...
process.hltbitanalysis.RunParameters.HistogramFile = cms.untracked.string('hlt_bTagDijetV11_HLT.root')
