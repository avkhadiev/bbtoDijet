...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/data/Run2016B/HLTPhysics/AOD/PromptReco-v2/000/274/998/00000/22E3D39A-6633-E611-836C-02163E011821.root'),
    inputCommands = cms.untracked.vstring('keep *'),
    secondaryFileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/data/Run2016B/HLTPhysics/RAW/v2/000/274/998/00000/0065CD2D-5832-E611-A907-02163E014649.root', 
...
process.datasets = cms.PSet(
    AlCaElectron = cms.vstring('AlCa_DoubleEle_CaloIdL_TrackIdL_IsoVL_DZ_v4', 
        'AlCa_DoubleEle_CaloIdL_TrackIdL_IsoVL_v4', 
        'AlCa_SingleEle_WPVeryLoose_Gsf_v4'),
    AlCaLumiPixels = cms.vstring('AlCa_LumiPixels_Random_v2', 
        'AlCa_LumiPixels_ZeroBias_v4'),
    AlCaP0 = cms.vstring('AlCa_EcalEtaEBonly_v5', 
        'AlCa_EcalEtaEEonly_v5', 
        'AlCa_EcalPi0EBonly_v5', 
        'AlCa_EcalPi0EEonly_v5'),
    AlCaPhiSym = cms.vstring('AlCa_EcalPhiSym_v5'),
    BTagCSV = cms.vstring('HLT_DoubleJet90_Double30_DoubleBTagCSV_p087_v2', 
...
process.simBmtfDigis = cms.EDProducer("L1TMuonBarrelTrackProducer",
    DTDigi_Source = cms.InputTag("unpackBmtf"),
...
process.simCaloStage2Layer1Digis = cms.EDProducer("L1TCaloLayer1",
    ...
    hcalToken = cms.InputTag("unpackHcal"),
...
process.simEmtfDigis = cms.EDProducer("L1TMuonEndCapTrackProducer",
    CSCInput = cms.InputTag("unpackCsctf")
)
...
process.simOmtfDigis = cms.EDProducer("L1TMuonOverlapTrackProducer",
    ...
    srcDTPh = cms.InputTag("unpackBmtf"),
    srcDTTh = cms.InputTag("unpackBmtf"),
...
process.hltbitanalysis = cms.EDAnalyzer("HLTBitAnalyzer",
    ...
    RunParameters = cms.PSet(
        ...
        HistogramFile = cms.untracked.string('hlt_bTagDijetV11_HLT.root'),
        Monte = cms.bool(True),
    ...
    l1results = cms.InputTag("hltGtStage2Digis","","TEST"),
...
process.SimL1Emulator = cms.Sequence(process.unpackEcal+process.unpackHcal+process.unpackCSC+process.unpackDT+process.unpackRPC+process.unpackCsctf+process.unpackBmtf+process.SimL1EmulatorCore+process.packCaloStage2+process.packGmtStage2+process.packGtStage2+process.rawDataCollector)
...
process.L1TriggerMenu = cms.ESProducer("L1TUtmTriggerMenuESProducer",
    L1TriggerMenuFile = cms.string('L1Menu_Collisions2016_v4.xml')
)
...
process.caloStage2Params = cms.ESProducer("L1TCaloParamsESProducer",
    ...
    egIsoLUTFile = cms.FileInPath('L1Trigger/L1TCalorimeter/data/IsoIdentification_0.25_adapt_extrap_v16.04.05.txt'),
    ...
    tauCalibrationLUTFile = cms.FileInPath('L1Trigger/L1TCalorimeter/data/Tau_Calibration_LUT_Layer1Calibration_v9.0.0.txt'),
    ...
    tauIsoLUTFile = cms.FileInPath('L1Trigger/L1TCalorimeter/data/Tau_Iso_LUT_Option_21_Layer1Calibration_noCompressionBlock_v4.0.0.txt'),
