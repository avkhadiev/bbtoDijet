...
process.bbtoDijet.HLTProcessName = cms.string(process.name_() )
process.bbtoDijet.hltresults = cms.InputTag( 'TriggerResults','', process.name_())
process.bbtoDijet.l1results = cms.InputTag('hltGtStage2Digis', '', process.name_())
process.bbtoDijet.RunParameters.HistogramFile = cms.untracked.string('hlt_bTagDijetV11.root')
process.bbtoDijet.RunParameters.isData = cms.untracked.bool(True)
