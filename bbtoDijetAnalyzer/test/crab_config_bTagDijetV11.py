...
name = 'bbtoDijetAnalyzer_test' # will be part of the work area name and the storage subdir name
runNom = '274998' #
...
config.Data.totalUnits = 1000000 # should be sufficient for memory management testing
